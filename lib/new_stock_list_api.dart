...
class NewStockListAPI extends StatefulWidget {
      final bool addId;

  NewStockListAPI({Key? key, this.addId = false}) : super(key: key);

  @override
 
  _NewStockListAPIState createState() => _NewStockListAPIState();
   


  static Future<File> generateCenteredText({bool addId = false}) {
    return _NewStockListAPIState()._generateCenteredText(addId:addId);
  }
...
class _NewStockListAPIState extends State<NewStockListAPI> {
  @override
